<!-- BEGIN: sectionreviews Menu-->
<section class="section-padding pb-0" id="reviews">
    <div class="container">
        <div class="row">

            <div class="col-12">
                <h2 class="text-center mb-lg-5 mb-4">Our Rew </h2>
                ...
                <div class="owl-carousel reviews-carousel">
                    ...
                    <figure class="reviews-thumb d-flex flex-wrap align-items-center rounded">
                        ...
                        <img src="{{asset('WebSite/images/reviews/beautiful-woman-face-portrait-brown-background.jpeg')}}" class="img-fluid reviews-image" alt="">
                    ...
                    <figure class="reviews-thumb d-flex flex-wrap align-items-center rounded">
                        ...
                        <img src="{{asset('WebSite/images/reviews/senior-man-wearing-white-face-mask-covid-19-campaign-with-design-space.jpeg')}}" class="img-fluid reviews-image" alt="">
                    ...
                    <figure class="reviews-thumb d-flex flex-wrap align-items-center rounded">
                        ...
                        <img src="{{asset('WebSite/images/reviews/portrait-british-woman.jpeg')}}" class="img-fluid reviews-image" alt="">
                    ...
                    <figure class="reviews-thumb d-flex flex-wrap align-items-center rounded">
                        ...
                        <img src="{{asset('WebSite/images/reviews/woman-wearing-mask-face-closeup-covid-19-green-background.jpeg')}}" class="img-fluid reviews-image" alt="">
